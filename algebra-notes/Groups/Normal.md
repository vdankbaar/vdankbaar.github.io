...
> 1. This product of [Cosets](./Coset.md) can be seen as an [associative](../Associativity.md) [Law of composition](../Law%20of%20composition.md) on $G'$.  
> 2. The [Cosets](./Coset.md) $H$ can be seen as a [Unit Element](../Unit%20Element.md) under this [Law of composition](../Law%20of%20composition.md).  
...
>As $H$ is the [Unit Element](../Unit%20Element.md) $H=HH$. From this it follows that $xH=HH$ and $x=H$.  
