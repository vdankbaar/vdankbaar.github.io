...
## Abelian (Commutative)  
A tower is [Abelian (Commutative)](../Commutativity_28Abelian29.md) if it is normal and if each [Factor Group (Modulo)](../Groups/Factor_Group_28Modulo29.md) $G_i/G_{i+1}$ is [Abelian (Commutative)](../Commutativity_28Abelian29.md).  
  
## Cyclic  
A tower is [Cyclic](../Groups/Cyclic.md) if it is [Normal](../Groups/Normal.md) and if each [Factor Group (Modulo)](../Groups/Factor_Group_28Modulo29.md) $G_i/G_{i+1}$ is [Cyclic](../Groups/Cyclic.md).  
## Solvable  
